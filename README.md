...
**Создание тренировки** — кнопка **«+ Новое»** в нижней части экрана открывает модальное окно выбора типа:

- **Серия** — серия на 10 выстрелов. Счётчик `выстрел/10` отображается в заголовке. При достижении 10 выстрелов серия завершается автоматически и появляется диалог выбора следующего шага.
- **Упражнение ПП-3** — 60 выстрелов, разбитых на 6 серий по 10. Прогресс серий отображается в виде чипов-блоков: текущая серия и пройденные серии видны на экране тренировки. Каждая серия завершается автоматически при 10 выстрелах.
